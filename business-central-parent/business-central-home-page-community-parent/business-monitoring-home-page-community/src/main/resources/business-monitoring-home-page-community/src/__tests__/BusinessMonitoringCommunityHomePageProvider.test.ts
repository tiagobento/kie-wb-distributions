...
describe("BusinessMonitoringCommunityHomePageProvider", () => {
  describe("get", () => {
    beforeEach(() => {
    ...
    describe("with FULL profile", () => {
      ...
      test("should return consistent main data", () => {
        const model = new BusinessMonitoringCommunityHomePageProvider().get(profile);
      ...
      test("should return a correct design card", () => {
        ...
        expect(designCard.perspectiveId).toEqual("ContentManagerPerspective");
        ...
        expect((designDescription[1] as HomeApi.CardDescriptionLinkElement).text).toEqual("pages");
        expect((designDescription[1] as HomeApi.CardDescriptionLinkElement).targetId).toEqual("ContentManagerPerspective");
